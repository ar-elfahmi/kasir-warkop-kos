<x-app-layout>
    <div class="max-w-lg mx-auto p-4">
        <h1 class="text-xl font-bold mb-4">Edit Topping</h1>

        <form method="POST" action="{{ route('toppings.update', $topping->id) }}" class="bg-white rounded-lg shadow p-4 space-y-4">
            @csrf @method('PUT')
